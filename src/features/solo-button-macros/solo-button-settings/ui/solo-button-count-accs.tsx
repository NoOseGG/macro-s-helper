...
export const SoloButtonCountAccs = () => {
  const countAccs = useSoloButtonStore((state) => state.countAccs);
  const setCountAccs = useSoloButtonStore((state) => state.setCountAccs);
